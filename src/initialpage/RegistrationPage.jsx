                      ...
                      <div className="account-box">
                        <div className="account-wrapper">
                          ...
                          <div style={{marginTop:'10px'}}>
                            <label style={{fontSize:'40px', fontWeight:'bold'}}>Create Your<br/> Student Account.</label>
                          </div>
                          ...
                          <form action="/light/app/main/dashboard" style={{marginTop:'41px'}}>
                            <div className="form-group">
                              <input className="form-control" type="text" id="std_firstname" placeholder="First Name"/>
                            </div>
                            <div className="form-group">
                              <input className="form-control" type="text" id="std_lastname" placeholder="Last Name"/>
                            </div>
                            <div className="form-group">
                              <input className="form-control" type="email" id="std_email" placeholder="Email Address"/>
                            </div>
                            <div className="form-group">
                              <input className="form-control" type="password" id="std_password" placeholder="Password" />
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group text-center">
                              <button className="btn btn-primary account-btn" type="button" id="btn_std_signup">Register Now</button>
                            </div>
                            <div className="form-group">
                              <p>Or, Log in with</p>
                            </div>
