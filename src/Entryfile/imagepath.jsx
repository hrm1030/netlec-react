...
export {default as Facebook} from 'Assets/img/icon-facebook.svg';
export {default as Twitter} from 'Assets/img/icon-twitter.svg';
export {default as Instagram} from 'Assets/img/icon-instagram.svg';
...
export {default as PlayStore} from 'Assets/img/play store.svg';
export {default as AppStore} from 'Assets/img/app store.png';
export {default as StudentCard} from 'Assets/img/StudentCard.png';
export {default as TutorVideo} from 'Assets/img/tutorvideo.png';
export {default as TutorEducation} from 'Assets/img/tutoreducation.png';
export {default as Sun} from 'Assets/img/sun.png';
export {default as Mon} from 'Assets/img/mon.png';
export {default as Tue} from 'Assets/img/tue.png';
export {default as Wed} from 'Assets/img/wed.png';
export {default as Thu} from 'Assets/img/thu.png';
